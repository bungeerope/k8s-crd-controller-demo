...
import (
	...
	infrav1 "kube.crd/demo-example/api/v1"
)
...
// +kubebuilder:rbac:groups=infra.quinn.domain,resources=virtulmachines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=infra.quinn.domain,resources=virtulmachines/status,verbs=get;update;patch
